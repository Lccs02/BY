...
LONG_TERM_GOALS = TableSpec(
    ...
    seeds=(
        ...
        },
        {
            ...
            "优先级": "P0",
            "状态": "进行中",
            "备注": "最高优先级。IoTJ 卫星多业务流量预测与 AAAI 多粒度时空预测 → World Model → RL → 网络/卫星网络智能决策；目标是至少形成 1 个真正具备 CCF-A 投稿质量的工作，坚持‘一个核心问题 + 一个最匹配会议’，420 小时仅监控连续投入。",
        },
        {
            "目标ID": "GOAL-GPA",
            "目标名称": "专业排名稳定前 5%",
    ...
    seeds=tuple(
        ...
        for key, goal, name, deadline, target, unit, note, status in (
            ...
            (
                ...
                "GOAL-RESEARCH",
                "IEEE S&P 2027 Cycle 2 投稿成熟度决策",
                "2026-11-01",
                1,
                "节点",
                "仅当已有完整贡献、充分实验且问题具有明确安全/隐私意义时，才进入 11 月 10 日摘要注册与 11 月 17 日投稿；若投稿，官方录用通知为 2027 年 3 月 5 日。否则明确延期，不为赶会强投。",
                "未开始",
            ),
            (
            ...
            (
                ...
                "GOAL-RESEARCH",
                "确定一个核心问题与唯一主投 CCF-A 会议",
                "2027-01-10",
                1,
                "节点",
                "按成果成熟度和方向匹配度选择 ICML、S&P 或最合适的 A 类备选；ICML 2027 日期仍按预计处理，未成熟则不投稿。",
                "未开始",
            ),
            (
                "CONF-20270331-NEXT-GATE",
                "GOAL-RESEARCH",
                "根据实验或评审结果决定下一轮/下一届顶会",
                "2027-03-31",
                1,
                "节点",
                "只保留一个主投方向；决定继续补实验、转投最匹配会议或延期，不并行堆多个 A 会。",
                "未开始",
            ),
            (
                "RES-20270415-DRAFT",
                "GOAL-RESEARCH",
                "形成 1 个具备 CCF-A 投稿质量的完整科研工作",
                "2027-04-15",
                1,
                "节点",
                "问题、方法、实验、局限和论文初稿形成闭环；衡量质量而非投稿数量。",
                "未开始",
            ),
            (
                "RES-20270520-CAMP",
...
CCF_A_SUBMISSION_ROUTE = TableSpec(
    name="07_CCF-A投稿路线",
    unique_key="会议",
    fields=(
        FieldSpec("会议"),
        FieldSpec("CCF方向", SINGLE_SELECT, ("人工智能", "计算机网络", "网络与信息安全")),
        FieldSpec("目标等级", SINGLE_SELECT, ("S", "A")),
        FieldSpec("预计投稿时间"),
        FieldSpec(
            "当前状态",
            SINGLE_SELECT,
    ...
    seeds=(
        {
            ...
            "CCF方向": "人工智能",
            "目标等级": "S",
            "预计投稿时间": "2027 年 1 月下旬（预计，待官方 CFP）",
            "当前状态": "调研",
            "对应科研项目": "World Model 驱动的网络智能决策",
        },
        {
            "会议": "IEEE S&P 2027 Cycle 2",
            "CCF方向": "网络与信息安全",
            "目标等级": "S",
            "预计投稿时间": "2026-11-17（官方；摘要注册 11-10）",
            "当前状态": "调研",
            "对应科研项目": "World Model 驱动的网络智能决策（仅明确安全/隐私问题）",
        },
        {
            "会议": "NSDI 2027 Fall Cycle",
            "CCF方向": "计算机网络",
            "目标等级": "A",
            "预计投稿时间": "2026-09-17（官方；摘要注册 09-10）",
            "当前状态": "未开始",
            "对应科研项目": "World Model 驱动的网络智能决策（仅已有成熟系统工作）",
        },
        {
            "会议": "USENIX Security 2027 Cycle 2",
            "CCF方向": "网络与信息安全",
            "目标等级": "A",
            "预计投稿时间": "2027-01-26（官方；论文注册 01-19）",
            "当前状态": "未开始",
            "对应科研项目": "World Model 驱动的网络智能决策（仅明确安全/隐私问题）",
        },
        {
            ...
            "CCF方向": "计算机网络",
            "目标等级": "A",
            "预计投稿时间": "2027 年 1–2 月（预计，待官方 CFP）",
            "当前状态": "未开始",
            "对应科研项目": "World Model 驱动的网络智能决策",
        },
    ),
